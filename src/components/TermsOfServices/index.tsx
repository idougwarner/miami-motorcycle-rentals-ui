...
import { DivTermsOfServicesContainer } from "./styles";

function TermsOfServices() {
  return (
    <DivTermsOfServicesContainer>
      <h1>Miami Motorcycle Rentals Terms of Service and All Policies</h1>
      ...
      <div>
        ...
        <p>
          <span>
            ...
            shall form a binding contract that allows you to use these
            Services.&nbsp;
          </span>
        </p>
        <h3>
        ...
        <p>
          <span>
            ...
            Rental and Reservation procedures as listed below in this
            document.&nbsp;
          </span>
        </p>
        <p>
        ...
        <p>
          <span>
            ...
            Motorcycle Rentals will respond to R
          </span>
          <span>
            eservation Requests in a timely manner, if Miami Motorcycle Rentals
            ...
            Requests may lapse or otherwise be terminated for
            non-response.&nbsp;
          </span>
        </p>
        <p>
        ...
        <p>
          <span>
            ...
            late will need to pay for the extension of their protection
            plan.&nbsp;&nbsp;
          </span>
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            <span>
              In a reckless manner i.e. Stunt driving, wheelies, burn-outs,
              etc.&nbsp;
            </span>
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            <span>
              ...
              resolution matters on behalf of Users as set forth in the
              Terms.&nbsp;
            </span>
          </li>
          <li>
            <span>
              ...
              shall be binding when accepted, or unless disputed by the
              User.&nbsp;
            </span>
          </li>
        </ul>
        ...
        <p>
          <span>
            *MFR: Minimum Financial Requirement as set by each individual
            State.&nbsp;
          </span>
        </p>
        <p>
          <span>
            ...
            “motorcycle” or termination by you of the Reservation
            Agreement.&nbsp;
          </span>
        </p>
        <p>
        ...
        <h3>
          <b>
            PHYSICAL DAMAGE TO THE VEHICLE IS YOUR FINANCIAL
            RESPONSIBILITY&nbsp;
          </b>
        </h3>
        <p>
          <span>
            ...
            charges incurred as agreed by the Parties during a
            transaction.&nbsp;
          </span>
        </p>
        <h3>
        ...
        <p>
          <span>
            ...
            these Miami Motorcycle Rentals terms including the passenger
            policy.&nbsp;
          </span>
        </p>
        <p>
        ...
        <p>
          <span>
            ...
            consult the Prohibited Activities Section of the Renter
            policy.&nbsp;
          </span>
        </p>
        <h4>
