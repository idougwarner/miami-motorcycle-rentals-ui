...
function generateBikeData(response: Bike, galleryMediaItems: MediaItem[], insurancePlans: BikeInsurance[]): BikeData {
  ...
  const bike: BikeDetails = {
    ...
    regularPrice,
    discountPrice,
    twoDaysDiscount: discountPercentages?.two || 0,
    threeDaysDiscount: discountPercentages?.three || 0,
    fourDaysDiscount: discountPercentages?.four || 0,
    fiveDaysDiscount: discountPercentages?.five || 0,
    distanceIncluded,
    highlights,
    features,
    extras,
